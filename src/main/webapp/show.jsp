...
<head>
    ...
    <!-- font-awesome-icons -->
    <!-- //font-awesome-icons -->
    <link href="http://fonts.googleapis.com/css?family=Playfair+Display+SC:400,400i,700,700i,900,900i&amp;subset=cyrillic,latin-ext"
          rel="stylesheet">
...
<div class="main">
    <h1>Killing Coming Soon!</h1>
    <div class="banner-right">
        <div class="banner-right-info">
            <p>Guangzhou Digital Media</p>
        </div>
        <!--timer-->
        ...
        <div>
            <button type="button" onclick=javascrtpt:window.location.href='scorelist.jsp'>积分榜</button>
        </div>
    </div>

    <!--<div class="w3layouts_copy_right">
        <div class="container">
            <p>Copyright &copy; 2017.GZDM All rights reserved.</p>
                <a target="_blank" href="http://www.969368.com/">推广链接</a>
        </div>
    </div>-->
</div>
<!-- //footer -->
